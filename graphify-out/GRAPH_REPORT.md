...
## Knowledge Gaps
- **331 isolated node(s):** `TaskRunExtended`, `metadata`, `graphify`, `ponytail`, `Usage` (+326 more)
...
- **What connects `TaskRunExtended`, `metadata`, `graphify` to the rest of the system?**

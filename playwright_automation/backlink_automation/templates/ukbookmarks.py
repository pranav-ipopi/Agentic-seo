...
BASE_URL = "https://www.ukbookmarks.com"
...
async def main():
    ...
    try:
        ...
        print("Navigating to https://www.ukbookmarks.com/register/ ...")
        try:
            await page.goto("https://www.ukbookmarks.com/register/", wait_until="commit", timeout=60000)
        except Exception as e:
        ...
        sitekey = "6LdsLkYUAAAAANTUsS-k_S47l1bSpqHPRG-U0XiI"
        ...
        if token:
            ...
            print("Navigating to https://www.ukbookmarks.com/submit/ ...")
            try:
                await page.goto("https://www.ukbookmarks.com/submit/", wait_until="commit", timeout=60000)
            except Exception as e:
            ...
            if not site_key:
                site_key = "6LdsLkYUAAAAANTUsS-k_S47l1bSpqHPRG-U0XiI"
            ...
            if await submit_btn.count() > 0:
                ...
                await page.screenshot(path="C:/Users/IPOPI/Desktop/Agentic-seo/scratch/before_submit.png")
                ...
                await page.screenshot(path="C:/Users/IPOPI/Desktop/Agentic-seo/scratch/after_submit_click.png")
            else:
            ...
            if await confirm_btn.count() > 0:
                ...
                try:
                    ...
                    pass
                await page.screenshot(path="C:/Users/IPOPI/Desktop/Agentic-seo/scratch/after_confirm_click.png")
            ...
            if backlink_url:
                ...
                try:
                    with open("C:/Users/IPOPI/Desktop/Agentic-seo/scratch/failed_page.html", "w", encoding="utf-8") as f:
                        f.write(await page.content())
                    await page.screenshot(path="C:/Users/IPOPI/Desktop/Agentic-seo/scratch/final_page.png")

# Graph Report - Agentic_SEO  (2026-06-23)

## Corpus Check
- 157 files · ~86,112 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 918 nodes · 1364 edges · 92 communities (76 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 40 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff32ef5b`
...
- `PATCH()` --calls--> `createServiceClient()`  [INFERRED]
  agentic-seo/app/api/clients/[id]/route.ts → agentic-seo/lib/supabase/server.ts
- `DELETE()` --calls--> `createServiceClient()`  [INFERRED]
  agentic-seo/app/api/keywords/[id]/route.ts → agentic-seo/lib/supabase/server.ts
- `DELETE()` --calls--> `createServiceClient()`  [INFERRED]
  agentic-seo/app/api/target_sites/[id]/route.ts → agentic-seo/lib/supabase/server.ts
...
Cohesion: 0.07
Nodes (37): POST(), DELETE(), DELETE(), DELETE(), POST(), GET(), PATCH(), POST() (+29 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (38): Failure Handler for Backlink Automation  Responsibilities:     - Classify errors, ArticleWorker, check_articles_today(), _fallback_article_body(), generate_article_body(), get_pending_job(), get_supabase(), lock_job() (+30 more)
...
Cohesion: 0.36
Nodes (3): Any, Execute the full automation flow for a site.          Args:             site_id:, Logger
...
## Knowledge Gaps
- **297 isolated node(s):** `metadata`, `Props`, `metadata`, `metadata`, `CATEGORIES` (+292 more)
...
- **Why does `Client` connect `Community 1` to `Community 0`, `Community 6`, `Community 12`, `Community 14`, `Community 47`, `Community 31`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `StealthBrowserManager` connect `Community 4` to `Community 33`, `Community 1`, `Community 7`, `Community 46`, `Community 21`, `Community 26`?**
...
- **What connects `metadata`, `Props`, `metadata` to the rest of the system?**

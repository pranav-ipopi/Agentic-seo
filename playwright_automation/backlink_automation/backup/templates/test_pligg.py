...
async def main():
    parser = argparse.ArgumentParser(description="Test Generic Pligg Automation")
    parser.add_argument("--target_site", type=str, required=True, help="The Pligg site URL (e.g. https://livebookmarking.com)")
    ...
    logger.info(f"Testing PliggGenericTemplate on {args.target_site} with client_site={args.client_site}, keyword={args.keyword}")
